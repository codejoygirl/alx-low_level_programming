...
/**
 * main - The Entry point for program to copy files
 * @argc: The Count of arguments to be passed
 * @argv: The Array of char pointers to the arguments
 *
...
/**
 * safe_close - This closes file, exits/prints error if close encounters error
 * @filedescriptor: The file descriptor for file to be closed
 *
...
/**
 * read_error - This prints a read error message to stderr
 * @filename: The filename to print out for errorcode
 *
 * Return: Returns void
 */
...
/**
 * write_error - This prints a write error message to stderr
 * @filename: The filename to print out for errorcode
 *
 * Return: Returns void
 */
